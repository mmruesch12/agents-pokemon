...
# pret CHERRYGROVE group (Route 30/31, Cherrygrove City, Mr. Pokemon).
MAPGROUP_JOHTO_ROUTES = 26
MAPGROUP_CHERRYGROVE = MAPGROUP_JOHTO_ROUTES
# pret VIOLET group (Violet City, Violet Gym, Route 32/…).
MAPGROUP_VIOLET = 10
# Deprecated alias — was incorrectly set to Olivine (group 1). Prefer MAPGROUP_CHERRYGROVE.
MAPGROUP_JOHTO_CITIES = MAPGROUP_CHERRYGROVE
MAP_NEW_BARK_TOWN = 4
MAP_ROUTE_29 = 3
MAP_ELMS_LAB = 5
...
MAP_ROUTE_30 = 1
MAP_ROUTE_31 = 2
MAP_CHERRYGROVE_CITY = 3
MAP_MR_POKEMONS_HOUSE = 10
MAP_ROUTE_31_VIOLET_GATE = 11
MAP_VIOLET_CITY = 5
MAP_VIOLET_GYM = 7
...
MAP_KEY_ROUTE_31 = f"{MAPGROUP_JOHTO_ROUTES}:{MAP_ROUTE_31}"
MAP_KEY_CHERRYGROVE_CITY = f"{MAPGROUP_CHERRYGROVE}:{MAP_CHERRYGROVE_CITY}"
MAP_KEY_MR_POKEMONS_HOUSE = f"{MAPGROUP_JOHTO_ROUTES}:{MAP_MR_POKEMONS_HOUSE}"
MAP_KEY_ROUTE_31_VIOLET_GATE = f"{MAPGROUP_JOHTO_ROUTES}:{MAP_ROUTE_31_VIOLET_GATE}"
MAP_KEY_VIOLET_CITY = f"{MAPGROUP_VIOLET}:{MAP_VIOLET_CITY}"
MAP_KEY_VIOLET_GYM = f"{MAPGROUP_VIOLET}:{MAP_VIOLET_GYM}"
...
MAP_NAMES: dict[tuple[int, int], str] = {
    ...
    (MAPGROUP_JOHTO_ROUTES, MAP_ROUTE_31): "Route 31",
    (MAPGROUP_JOHTO_ROUTES, MAP_CHERRYGROVE_CITY): "Cherrygrove City",
    (MAPGROUP_JOHTO_ROUTES, MAP_MR_POKEMONS_HOUSE): "Mr. Pokemon's House",
    (MAPGROUP_JOHTO_ROUTES, MAP_ROUTE_31_VIOLET_GATE): "Route 31 Violet Gate",
    (MAPGROUP_VIOLET, MAP_VIOLET_CITY): "Violet City",
    (MAPGROUP_VIOLET, MAP_VIOLET_GYM): "Violet Gym",
}
