...
MAP_GRIDS: dict[str, list[list[int]]] = {
    ...
    "24:3": _grid_from_rows(
        [
            ...
            "111111111111111111111111111111111111001100010000000000000000",  # y=9 block x=27 — no up from ledge connector
            "111111111111111111111111000000000000000001010000000001111111",  # y=10 ROM walkable x=25 from (24,10)
            "111111111111111111111110010000000000000000100000000000111111",  # y=11 x=25,26 ROM walkable west descent
