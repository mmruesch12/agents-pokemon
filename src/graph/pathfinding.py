...
MAP_GRIDS: dict[str, list[list[int]]] = {
    ...
    "24:3": _grid_from_rows(
        [
            ...
            "111111111111111111111111011010000000000000100000000000111111",  # y=11 block x=22-23 trap; x=25-26 east spur
            ...
            "000000000000000000000100000000000011110000000000111111111111",  # y=14 open x=24 south column
